...
const gallerySlides = [
  { img: "photo-1555939594-58d7cb561ad1", title: "El Fuego", desc: "La parrilla encendida desde las 6am. El corazon de Ceniza late en carbon y brasas seleccionadas." },
  { img: "photo-1559339352-11d035aa65de", title: "El Salon", desc: "Un bodegon que se niega a cambiar. Suelo de baldosas antiguas, sillas de madera gastadas." },
  { img: "photo-1546069901-ba9599a7e63c", title: "El Plato", desc: "Cada plato lleva la firma del fuego. Maduracion propia, cortes seleccionados." },
  { img: "photo-1551218808-94e220e084d2", title: "La Bodega", desc: "Vinos de bodegas familiares que visitamos una por una." },
  { img: "photo-1414235077428-338989a2e8c0", title: "La Mesa", desc: "Mesas para compartir sin apuro. El unico requisito es querer estar ahi." },
  { img: "photo-1504674900247-0877df9cc836", title: "El Detalle", desc: "Lo que hace diferente a Ceniza no son las grandes decisiones, son las pequenas." },
  { img: "photo-1414235077428-338989a2e8c0", title: "La Noche", desc: "Cuando baja el sol, Ceniza se transforma. Luces tenues y copas." },
  { img: "photo-1546069901-ba9599a7e63c", title: "El Regreso", desc: "Lo que mas nos gusta no es que vengan, es que vuelvan." },
];

export default function P3GastronomiaV5() {
  ...
  return (
    <div className="p3-r">
      ...
      <div className="p3-c">
        ...
        <section id="galeria" style={{padding:"0 0 1rem"}}>
          <p className="p3-sl2" style={{textAlign:"center"}}>El lugar</p>
          <h2 className="p3-st2" style={{textAlign:"center"}}>Scrollea y <span className="g">descubre</span></h2>
          <p className="p3-ss" style={{textAlign:"center",margin:"0 auto"}}>Las imagenes aparecen al pasar. Click para expandir.</p>
        </section>
        ...
        <section className="p3-s" id="contacto">
          ...
          <div className="p3-ci">
            <form className="p3-cf">
              ...
              <select><option>2 pax</option><option>4 pax</option><option>6+</option></select>
              <button type="submit" className="p3-cb">Reservar →</button>
            </form>
            <div>
              <div className="p3-hl"><span>Dir</span><span>Av. Platanos 1842</span></div>
              <div className="p3-hl"><span>Tel</span><span>+54 11 0000-0000</span></div>
        ...
        <footer className="p3-f">
          <div className="p3-fg">
            ...
            <div><h4 style={{color:"var(--p3-neon)",marginBottom:"1rem",fontFamily:"var(--t-font-display)",fontSize:"0.7rest"}}>RESTAURANTE</h4><a href="#galeria" style={{display:"block",marginBottom:"0.5rem"}}>Galeria</a><a href="#contacto" style={{display:"block",marginBottom:"0.5rem"}}>Reservas</a><a href="#contacto" style={{display:"block"}}>Contacto</a></div>
